...
const VoucherTabelRow = ({
  ...
  const {changeQuantity} = useRecordStore();
  ...
  return (
    <tr className="bg-slate-800 border-b border-gray-700 group hover:bg-slate-700 transition-all duration-200">
      ...
      <td className="px-6 py-4 text-end">
        ...
        <button onClick={handleIncreaseQuantity} className="q-add pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 translate-x-6 group-hover:translate-x-0 duration-200 bg-blue-100 text-blue-600 p-1 rounded">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <td>
        ...
        className=" pointer-events-none duration-200 opacity-0 group-hover:opacity-100 group-hover:pointer-events-auto left-full top-3 translate-x-14 active:scale-75 bg-blue-100 p-2 rounded-lg">
...
export default VoucherTabelRow;
